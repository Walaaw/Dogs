...
export default function Dog({dog,item}) {
  return (
    ...
    <div className={`bg-white shadow-sm rounded p-2 ${dogstyle.box} `}>
     ...
     <figure>
     <Link to={`/details/${dog.name}`}> <img src={item?`https://cdn2.thedogapi.com/images/${item.reference_image_id}.jpg`:dog.image.url} alt="dog"  className={`w-100 rounded ${dogstyle.dog}`}/> </Link>
        <figcaption >
